...
// lpeek(dword zeropage($49) address)
lpeek: {
    .label t = $28
    .label address = $49
...
// memset(void* zeropage($5c) str, byte register(X) c, word zeropage($58) num)
memset: {
    .label end = $58
    .label dst = $5c
    .label num = $58
